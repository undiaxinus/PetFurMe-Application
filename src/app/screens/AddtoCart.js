		...
		<View style={styles.container}>
			...
			<View style={styles.infoCard}>
				...
				<Text style={styles.description}>
					...
					carefully selected ingredients, Special Dog offers a range of products
					designed to support various aspects of a dog's health, including skin
					and coat condition, digestive health, and overall vitality.
				</Text>

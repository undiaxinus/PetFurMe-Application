...
$API_BASE_URL = 'http://192.168.6.200'; // Make sure this matches your React Native API_BASE_URL
            ...
            if (!empty($row['photo'])) {
                try {
                    ...
                    if (file_exists($absolute_path)) {
                        ...
                        $photoUrl = 'http://192.168.6.200/PetFurMe-Application/api/pets/' . $photo_path;
